...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "autoFaceOnCast": "Автоповорот к цели при заклинании",
      "autoFaceOnCastHelp": "При применении способности по цели персонаж поворачивается к ней, чтобы удары и снаряды выходили спереди. Если отключить, вернется классическое поведение: заклинание по цели, к которой персонаж не повернут, будет отклонено.",
