...
// resolves instantly. The async surface is mirrored structurally so the admin bootstrap
// awaits the same shape as the game client; admin never performs the static->lazy flip.
